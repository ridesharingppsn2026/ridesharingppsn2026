...
Solution first_improvement_next_solution(const LandscapeElement &element, const std::vector<Solution>* neighborhood);
Solution non_dominated_set_next_solution(const LandscapeElement &element, const std::vector<Solution>* neighborhood);
